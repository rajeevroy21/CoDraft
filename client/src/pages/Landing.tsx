...
//          </div>
//          <span className="text-sm font-bold tracking-tight text-text-primary">CoDraft</span>
//        </div>
//        <div className="flex items-center gap-2">
//          <button
...
//                CoDraft is a shared document editor that stays live while your team is in it.
...
//                      CoDraft.app/editor/sprint-3-retro
//                    </div>
//                  </div>
//
//                  {/* Presence in toolbar */}
...
//            </div>
//            <span className="text-sm font-semibold text-text-primary">CoDraft</span>
...
const MOCK_USERS: MockUser[] = [
  ...
  { id: 'Ranjan',  initials: 'Rk', color: '#F59E0B', name: 'Ranjan k.'  },
];
...
const BLOCKS: Array<{ id: string; typist: string | null; text: string }> = [
  ...
  },
  {
    id: 'b3',
    typist: 'aarav',
    text: 'So we built CoDraft. CRDT math — two people can type in the same sentence simultaneously and both edits survive.',
  },
  {
    id: 'b4',
    typist: 'Ranjan',
    text: "(Ranjan wrote this paragraph while Aarav was still typing the one above it. Both are here. This is the whole point.)",
  },
];
    ...
    <div className="min-h-screen bg-bg text-text-primary">
      ...
      <nav className="sticky top-0 z-50 border-b border-border bg-bg/95 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-6 h-12 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-bold tracking-tight">CoDraft</span>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-6">
          ...
          <div className="lg:col-span-5 flex flex-col lg:pt-4">
            ...
            <p className="text-[0.94rem] text-text-secondary leading-relaxed mb-2 max-w-[360px]">
              CoDraft is a shared document editor that stays live while your team
            ...
            <div className="border-t border-border pt-5">
              <p className="text-xs text-text-muted font-mono leading-relaxed">
                ...
                <br />
                 submission ·{' '}
                <a
                  href="https://github.com/ziennaa/CoDraft"
                  target="_blank"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          <div className="lg:col-span-7">
            ...
            <p className="text-sm text-text-secondary leading-relaxed max-w-md mb-2">
              CoDraft is a shared workspace. Every document is accessible via its URL.
      ...
      <footer className="max-w-7xl mx-auto px-6 py-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-semibold text-text-primary">CoDraft</span>
          <span className="text-xs text-text-muted">
